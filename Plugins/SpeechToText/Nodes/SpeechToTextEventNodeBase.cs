...
/// <summary>
/// Base class for SpeechToText event trigger nodes.
/// </summary>
public abstract class SpeechToTextEventNodeBase : IFlowTriggerNode
{
    public abstract string TypeId { get; }
    public abstract string DisplayName { get; }
    public string Category => FlowNodeCategory.Trigger;
    public abstract string? Description { get; }
    public string Icon => "mic";
    ...
    public virtual Task StartAsync(IFlowNodeInstance instance, IServiceProvider services, CancellationToken cancellationToken)
    {
        ...
        if (services.GetService(typeof(SpeechToTextTriggerManager)) is SpeechToTextTriggerManager triggerManager)
        {
    ...
    public virtual Task StopAsync(IFlowNodeInstance instance)
    {
        ...
        {
            var triggerManager = services.GetService(typeof(SpeechToTextTriggerManager)) as SpeechToTextTriggerManager;
